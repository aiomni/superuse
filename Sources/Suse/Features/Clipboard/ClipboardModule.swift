...
final class ClipboardModule: FeatureModule {
    ...
    func makeSettingsView() -> NSView {
        ...
        func toggle(_ title: String, subtitle: String? = nil, key: String) -> NSView {
            UI.toggleRow(title, subtitle: subtitle, isOn: defaults.bool(forKey: key)) { [weak self] enabled in
